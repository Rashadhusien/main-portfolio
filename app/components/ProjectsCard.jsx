...
//       {arr.length > 2 && (
//         <div onClick={handleViewMore} className="mx-auto group cursor-pointer">
//           <span className="mx-auto bg-transparent  duration-300 border-2 dark:group-hover:border-white  group-hover:border-black cursor-pointer w-[30px] md:w-[40px] px-8 py-4 rounded-full flex justify-center items-center">
//             {view ? (
//               <span className="arrow-down border-2 border-black dark:border-white before:border-t-transparent before:border-l-transparent before:border-b-black dark:before:border-b-white before:border-r-black dark:before:border-r-white before:bottom-0"></span>
//             ) : (
//               <span className="arrow-down border-2 border-black dark:border-white before:border-b-transparent before:border-r-transparent before:border-t-black dark:before:border-t-white before:border-l-black dark:before:border-l-white"></span>
//             )}
//           </span>
//           <p className="text-black dark:text-white text-xl opacity-50 group-hover:opacity-100 duration-300 pt-3 text-center">
...
const ProjectsCard = ({ arr }) => {
  ...
  const visibleProjects = arr.slice(0, visibleCount);
          ...
          {arr.length === 0 ? (
            ...
            visibleProjects.map((item) => (
              <motion.article
                ...
                key={item.id}
                className="group overflow-hidden rounded-md hover:scale-[1.01] shadow-md transition-transform duration-300"
              >
                <a
                  href={item.moreUrl}
                  target="_blank"
